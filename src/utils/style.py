STYLE_MAP = {
    "Disney": {
        "image_url": [
            ...
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/tmps6rjszf_.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721038559663567.png",
        ],
    ...
    "Manhwa": {
        "image_url": [
            ...
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721210169115559.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/production/a28a4fea5af07d3e8743e497caa7defa.PNG",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721041156890906.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721040380473767.png",
        ],
    ...
    "Miyazaki": {
        "image_url": [
            ...
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/tmpbm11htu_.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721097961676314.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721208005044549.png",
        ],
        "description": "illustration style of Hayao Miyazaki style in Studio Ghibli",
        "weight": "100",
    },
    "国风动漫": {
        "image_url": [
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721116784376066.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721117219326289.png",
        ],
    ...
    "Pixar": {
        "image_url": [
            ...
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721211338277429.png",
        ],
        "description": "illustration style of Pixar animated films. --niji 6",
        "weight": "50",
    },
    # 等待测试
    "Shinkai": {
        "image_url": [
            ...
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721115585294860.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721207868559517.png",
        ],
    ...
    "Japanese Anime": {
        "image_url": [
            ...
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721112422996459.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721113021760509.png",
        ],
    ...
    "American Comics": {
        "image_url": [
            ...
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/production/95c125fde4feb30260635554bcc2e85d.PNG",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721106945022195.png",
        ],
    ...
    "Photorealistic": {
        "image_url": [
            ...
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721124290907693.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721125148935432.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721125372457395.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721208358900163.png",
        ],
    ...
    "Horror": {
        "image_url": [
            ...
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721120947577135.png",
            "https://wawawriter-public.oss-cn-hangzhou.aliyuncs.com/dev/1721208212567369.png",
        ],
        "description": "Illustration style of Horror Thriller style with dark colors, intense shadows, isolated settings, and a suspenseful atmosphere.",
        "weight": "50",
    },
}
...
#     # print(STYLE_MAP)
#
#     for style, data in STYLE_MAP.items():
#         new_urls = []
#         for image_name in data["image_url"]:
#             with open(
#                 BASEDIR.joinpath(f"resource/style_samples_img/{image_name}.png"), "rb"
#             ) as f:
#                 img = f.read()
#             result = upload_client.upload_file(img, f"{image_name}.png")
#             new_urls.append(result)
#         data["image_url"] = new_urls
#         STYLE_MAP[style] = data
#
#     print(STYLE_MAP)
